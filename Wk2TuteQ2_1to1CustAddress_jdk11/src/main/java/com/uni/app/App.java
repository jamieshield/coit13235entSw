...
@Entity @Data class Customer {
    ...
    // inversed
    @OneToOne(mappedBy="customer") private Address address; // wanted bi-inverse/child
    public void setAddress(Address address) { // stops Lombok's
        this.address=address; // doesn't nothing at persistence layer
        //if (!Objects.equals(this,address.getCustomer())) { address.setCustomer(this); }
...
@Entity @Data class Address {
    ...
    public void setCustomer(Customer customer) {
        ...
        if (!Objects.equals(this,customer.getAddress())) { customer.setAddress(this); }
    }*/
}
...
@Transactional @Component @Data class AppInit implements ApplicationRunner {
    ...
    public void run(ApplicationArguments args) throws Exception {
        ...
        /* Date dob = new SimpleDateFormat("yyyy-mm-dd").parse("2006-01-01");
