...
class Employee { // Child
    ...
    private String name;
    @OneToOne(mappedBy="employee") Locker locker; // parent of bi (persisted indirectly)
...
class Locker { // Parent
    ...
    @OneToOne private Employee employee; // rob from 1 (child:Emp), give to many (parent:Locker)
